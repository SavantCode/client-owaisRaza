...
export default function AppInstallPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto bg-white min-h-screen font-sans">
      {/* App Header */}
      <div className="w-full p-6 pb-4 max-w-full flex flex-col gap-4 mt-5">
      ...
      {/* Install Button */}
      <div className="px-6 py-4 mt-2 sm:mb-0">
        <button
        ...
        <div className="flex items-center justify-center mt-5 mb-3">
          <button
            ...
            className="flex items-center gap-2 mb-1 text-green-700 hover:text-green-600 text-sm"
          >
        ...
        <div className="flex items-center gap-2 mt-5 mb-4 text-sm text-gray-600">
      ...
      {/* Screenshots */}
      <div className="px-6 py-4 mt-4 mb-4 sm:mb-0">
        <div className="flex gap-3 overflow-x-auto pb-2 hide-scrollbar">
          <div className="flex-shrink-0 w-48 h-80 sm:w-48 sm:h-80 w-32 h-56 rounded-lg overflow-hidden border border-gray-200">
            <img
              src={img1}
